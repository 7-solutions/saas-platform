...
export function UserMenu({ user, onLogout, onProfile, onSettings, className, }) {
            ...
            <CardContent className="p-4">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  {onProfile && (<Button variant="ghost" className="w-full justify-start" onClick={() => {
                    onProfile();
                    setIsOpen(false);
                }}>
                  ...
                  {onSettings && (<Button variant="ghost" className="w-full justify-start" onClick={() => {
                    onSettings();
                    setIsOpen(false);
                }}>
