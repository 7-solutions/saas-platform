...
export default function GlobalError({ error, reset }: GlobalErrorProps) {
  useEffect(() => {
    // Log critical error
    console.error('CMS Global error:', error);
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              A critical error occurred in the content management system. 
              Please refresh the page or contact your system administrator.
            </p>
